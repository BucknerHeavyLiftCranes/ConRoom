 ...
 * @param {number | undefined} [params.roomId] - The unique identifier of the room (optional, generated by the database).
...
export default class Room {
    constructor({
        ...
        this.roomId = roomId ? Number(roomId) : undefined;
        /**@type {string} */
        this.roomName = roomName;
        /**@type {string} */
        this.roomEmail = roomEmail;
        /**@type {boolean} */
        this.roomStatus = Boolean(roomStatus); // Ensure it's a boolean
        /**@type {number} */
        this.seats = seats;
        /**@type {boolean} */
    ...
    */
     ...
     * @throws {InvalidTimeFormatError} dateTime is in an invalid, nonconveritble format.
